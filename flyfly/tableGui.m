...
% Last Modified by GUIDE v2.5 03-Sep-2014 10:22:51
...
%Kristians code
setappdata(0,'network_on',get(handles.trigger_cb,'value'));
%/Kristians code
...
% --- Executes on button press in cb_network.
%function cb_network_Callback(hObject, eventdata, handles)
% hObject    handle to cb_network (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of cb_network


% --- Executes on button press in trigger_cb. Function added by Kristian
function trigger_cb_Callback(hObject, eventdata, handles)
% hObject    handle to trigger_cb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of trigger_cb
    setappdata(0,'network_on',get(handles.trigger_cb,'value'));
